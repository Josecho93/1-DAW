...
public class Main extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextFieldNivelSequia.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextFieldNivelSequiaActionPerformed(evt);
            }
        });

        jTextFieldNivelHumedadSuelo.setText("5");
        jTextFieldNivelHumedadSuelo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextFieldNivelHumedadSueloActionPerformed(evt);
            }
        });
    ...
    private void jButtonLlenarMedioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonLlenarMedioActionPerformed
        ...
        if (Convert.isValidInt(jTextFieldNivelSequia.getText())) {
            ...
            mensaje("El valor de sequia debe ser un numero entero");
            return;
        }
    ...
    private void jButtonVaciarMedioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonVaciarMedioActionPerformed
        ...
        if (Convert.isValidInt(jTextFieldNivelHumedadSuelo.getText())) {
            humedad = Convert.parseInt(jTextFieldNivelHumedadSuelo.getText());
        } else {
            mensaje("El valor de la humedad debe ser un numero entero");
            return;
        }
    ...
    private void jTextFieldNivelSequiaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextFieldNivelSequiaActionPerformed

    }//GEN-LAST:event_jTextFieldNivelSequiaActionPerformed

    private void jTextFieldNivelHumedadSueloActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextFieldNivelHumedadSueloActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jTextFieldNivelHumedadSueloActionPerformed
